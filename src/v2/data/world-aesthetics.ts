...
const AESTHETICS: Record<string, WorldAesthetic> = {
  ...
  // w180 — Overdrive — hot red/pink laser lock
  w180: {
    worldId: 'w180',
    primary: '#ff3344', glow: '#ff6677',
    background: '#0a0101',
    panel: 'rgba(16,4,5,0.93)',
    border: '#ff334433',
    muted: '#882222',
    gridColor: 'rgba(160,30,35,0.40)',
    spawnColor: '#ff6677', finishColor: '#ff9900',
    trackColor: '#ff3344',
    rackCase: '#0f0505', rackBorder: '#ff334444',
    rackGridV: 'rgba(160,30,35,0.40)', rackGridH: 'rgba(140,25,30,0.30)',
    rackRailDark: '#200a0a', rackRailLight: '#301010',
    staffColor: 'rgba(220,50,60,0.28)',
    barlineColor: 'rgba(240,65,75,0.50)',
    restColor: 'rgba(210,48,58,0.50)',
    tieColor: 'rgba(255,90,100,0.70)',
    fluidSeed: [230, 35, 45], fluidSeedStrength: 0.15,
  },

  // w200 — The Final Measure — violet/gold corrupted signal
  w200: {
    worldId: 'w200',
    primary: '#ffffff', glow: '#cceeff',
    background: '#020206',
    panel: 'rgba(6,6,14,0.95)',
    border: '#ffffff33',
    muted: '#445566',
    gridColor: 'rgba(80,80,120,0.40)',
    spawnColor: '#cceeff', finishColor: '#ff6600',
    trackColor: '#cceeff',
    rackCase: '#060610', rackBorder: '#ffffff44',
    rackGridV: 'rgba(80,80,120,0.40)', rackGridH: 'rgba(70,70,110,0.30)',
    rackRailDark: '#0e0e1c', rackRailLight: '#181830',
    staffColor: 'rgba(180,190,220,0.30)',
    barlineColor: 'rgba(200,210,240,0.52)',
    restColor: 'rgba(170,180,210,0.52)',
    tieColor: 'rgba(220,235,255,0.75)',
    fluidSeed: [120, 120, 200], fluidSeedStrength: 0.16,
  },
};
